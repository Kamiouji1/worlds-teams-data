let dados = [
   // LCK (Coreia do Sul)
    ...
    {titulo: "MAD Lions", descricao: "Uma equipe emergente na Europa, reconhecida por seu estilo de jogo estratégico e jogadores talentosos.", link: "https://madlions.com/"},

    // LCS (América do Norte)
    {titulo: "Cloud9", descricao: "Uma das equipes mais antigas e tradicionais da LCS, com uma grande base de fãs.", link: "https://www.cloud9.gg/"},

     // CBLOL (Brasil)
     {titulo: "paiN Gaming",descricao: "Uma das equipes mais tradicionais do Brasil, conhecida por sua paixão e dedicação ao cenário competitivo de League of Legends.", link: "https://www.pain.gg/"},
